...
import org.pantheon.gaia.compileur.outils.analyseur.syntaxe.grammaire.v1.terminal.CaractereGrammaire;
 ...
 */
public class CaractereGrammaireTest {

    /**
     * La grammaire à tester.
     */
    private final static CaractereGrammaire GRAMMAIRE_CARACTERE = new CaractereGrammaire();
    ...
    public void testerAnalyseValide()  {
        ...
        Assert.assertTrue(GRAMMAIRE_CARACTERE.analyser(texteSource));
    }
    ...
    public void testerAnalyseNonValide() {
        ...
        TexteSource texteSource = new TexteSource(unitesLexicales);
         ...
         Assert.assertFalse(GRAMMAIRE_CARACTERE.analyser(texteSource));
    }
